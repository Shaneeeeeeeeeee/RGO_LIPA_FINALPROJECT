...
namespace RGO_LIPA_FINALPROJECT
{
    public partial class adminFeedback : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'rGO_LIPADataSet.feedbacks' table. You can move, or remove it, as needed.
            this.feedbacksTableAdapter.Fill(this.rGO_LIPADataSet.feedbacks);
